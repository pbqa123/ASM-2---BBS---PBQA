...
#empty data handling
transactions_data.fillna(method='ffill', inplace=True)  # Fill blank values ​​with the value before
customers_data.fillna(method='bfill', inplace=True)     # Fill blank values ​​with the value after
